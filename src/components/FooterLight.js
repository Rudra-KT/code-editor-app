  ...
  <FooterWrapper>
      ...
      >
        <defs>
          <linearGradient id="bg" x2="0%" y2="100%">
            <stop
              offset="0%"
              style={{ stopColor: '#D8AE7E' }}  /* Top color for light theme */
            ></stop>
            <stop
              offset="100%"
              style={{ stopColor: '#FFE0B5' }}  /* Bottom color for light theme */
            ></stop>
          </linearGradient>
          <path
            id="wave"
    ...
    <section>
      <ul className="socials">
        ...
        <li><a href="https://github.com/Rudra-KT"><i className="fa-brands fa-github"></i></a></li>
